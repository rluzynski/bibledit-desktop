...
private:
  ...
  // Webkit callbacks.
  static void load_commit_cb (WebKitWebView* page, gpointer data);
  ...
  static void load_started_cb (WebKitWebView *page, gpointer user_data);
  void load_started (WebKitWebView *page);
  static void load_finished_cb (WebKitWebView *page, gpointer user_data);
